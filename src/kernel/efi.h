...
typedef void(EFI_API
				 *func_EFI_EventNotify)(IN efi_event Event, IN vptr Context);
...
typedef struct efi_pci_root_bridge_io_protocol {
	...
	efi_status(EFI_API *Map)(
		IN struct efi_pci_root_bridge_io_protocol	*This,
		IN efi_pci_root_bridge_io_protocol_operation Operation,
		IN vptr										 HostAddress,
		IN OUT u64									*NumberOfBytes,
		OUT efi_physical_address					*DeviceAddress,
		OUT vptr									*Mapping
	);
	efi_status(EFI_API *Unmap)(
		IN struct efi_pci_root_bridge_io_protocol *This,
		IN vptr									   Mapping
	);
	efi_status(EFI_API *AllocateBuffer)(
		IN struct efi_pci_root_bridge_io_protocol *This,
		IN efi_allocate_type					   Type,
		IN efi_memory_type						   MemoryType,
		IN u64									   Pages,
		OUT vptr								  *HostAddress,
		IN u64									   Attributes
	);
	efi_status(EFI_API *FreeBuffer)(
		IN struct efi_pci_root_bridge_io_protocol *This,
		IN u64									   Pages,
		IN vptr									   HostAddress
	);
	efi_status(EFI_API *Flush)(IN struct efi_pci_root_bridge_io_protocol *This);
	efi_status(EFI_API *GetAttributes)(
		IN struct efi_pci_root_bridge_io_protocol *This,
		OUT OPT u64								  *Supports,
		OUT OPT u64								  *Attributes
	);
	efi_status(EFI_API *SetAttributes)(
		IN struct efi_pci_root_bridge_io_protocol *This,
		IN u64									   Attributes,
		IN OUT OPT u64							  *ResourceBase,
		IN OUT OPT u64							  *ResourceLength
	);
	efi_status(EFI_API *Configuration)(
		IN struct efi_pci_root_bridge_io_protocol *This,
		OUT vptr								  *Resources
	);
...
typedef struct efi_simple_text_input_protocol {
	efi_status(EFI_API *Reset)(
		...
		IN b08									  ExtendedVerification
	);
	efi_status(EFI_API *ReadKeyStroke)(
		IN struct efi_simple_text_input_protocol *This,
...
typedef struct efi_simple_text_output_protocol {
	...
	efi_status(EFI_API *OutputString)(
		IN struct efi_simple_text_output_protocol *This,
		IN c16									  *String
	);
...
typedef struct efi_graphics_output_protocol {
	...
	efi_status(EFI_API *Blt)(
		IN struct efi_graphics_output_protocol	 *This,
		IN OUT OPT efi_graphics_output_blt_pixel *BltBuffer,
...
typedef struct efi_file_protocol {
	...
	efi_status(EFI_API *GetPosition)(
		IN struct efi_file_protocol *This,
		OUT u64						*Position
	);
	efi_status(EFI_API *SetPosition)(
		IN struct efi_file_protocol *This,
		IN u64						 Position
	);
	efi_status(EFI_API *GetInfo)(
		IN struct efi_file_protocol *This,
		IN efi_guid					*InformationType,
		IN OUT u64					*BufferSize,
		OUT vptr					 Buffer
	);
	efi_status(EFI_API *SetInfo)(
		IN struct efi_file_protocol *This,
		IN efi_guid					*InformationType,
		IN u64						 BufferSize,
		IN vptr						 Buffer
	...
	efi_status(EFI_API *ReadEx)(
		IN struct efi_file_protocol *This,
		IN OUT efi_file_io_token	*Token
	);
	efi_status(EFI_API *WriteEx)(
		IN struct efi_file_protocol *This,
		IN OUT efi_file_io_token	*Token
	);
	efi_status(EFI_API *FlushEx)(
		IN struct efi_file_protocol *This,
		IN OUT efi_file_io_token	*Token
	);
} efi_file_protocol;
...
typedef struct efi_boot_services {
	...
	// Miscellaneous Services
	VER(EFI, 1.1 +)
	void(EFI_API *CopyMem)(IN vptr Destination, IN vptr Source, IN u64 Length);
	VER(EFI, 1.1 +)
	void(EFI_API *SetMem)(IN vptr Buffer, IN u64 Size, IN u08 Value);
...
typedef struct efi_runtime_services {
	...
	// Time Services
	efi_status(EFI_API *GetTime)(
		OUT efi_time				  *Time,
		OUT OPT efi_time_capabilities *Capabilities
	);
	efi_status(EFI_API *SetTime)(IN efi_time *Time);
	efi_status(EFI_API *GetWakeupTime)(
		OUT b08		 *Enabled,
		OUT b08		 *Pending,
		OUT efi_time *Time
	);
	...
	efi_status(EFI_API *SetVirtualAddressMap)(
		IN u64					  MemoryMapSize,
		IN u64					  DescriptorSize,
		IN u32					  DescriptorVersion,
		IN efi_memory_descriptor *VirtualMap
	);
	efi_status(EFI_API *ConvertPointer)(
		IN u64	 DebugDisposition,
		IN vptr *Address
	);

	// Variable Services
	efi_status(EFI_API *GetVariable)(
		IN c16		*VariableName,
		IN efi_guid *VendorGuid,
		OUT OPT u32 *Attributes,
		IN OUT u64	*DataSize,
		OUT OPT vptr Data
	);
	efi_status(EFI_API *GetNextVariableName)(
		IN OUT u64		*VariableNameSize,
		IN OUT c16		*VariableName,
		IN OUT efi_guid *VendorGuid
	);
	efi_status(EFI_API *SetVariable)(
		IN c16		*VariableName,
		IN efi_guid *VendorGuid,
		IN u32		 Attributes,
		IN u64		 DataSize,
	...
	void(EFI_API *ResetSystem)(
		IN efi_reset_type ResetType,
		IN efi_status	  ResetStatus,
		IN u64			  DataSize,
		IN OPT vptr		  ResetData
	);

	// UEFI 2.0 Capsule Services
	efi_status(EFI_API *UpdateCapsule)(
		IN efi_capsule_header	  **CapsuleHeaderArray,
		IN u64						CapsuleCount,
		IN OPT efi_physical_address ScatterGatherList
	);
	efi_status(EFI_API *QueryCapsuleCapabilities)(
		IN efi_capsule_header **CapsuleHeaderArray,
		IN u64					CapsuleCount,
	...
	efi_status(EFI_API *QueryVariableInfo)(
		IN u32	 Attributes,
